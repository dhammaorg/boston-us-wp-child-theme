         ...
         <div id="search-login-bar" class="constrained-to-mid">
            <div id="search-login-bar-row">
               ...
               <div id="schedule-cell">
                  <a target="_blank" href="<?php echo get_theme_mod( 'dhamma_schedule_link'); ?>"><img alt="CALENDAR" src="<?php echo get_theme_root_uri();?>/dhara-child/images/calendar-blue-32.png"></a>
               </div>
            </div>
         </div>
      </div>
